...
export const TopBar: React.FC = () => {
  ...
  return (
    <header className="bg-white/95 backdrop-blur-md text-slate-800 shadow-xs sticky top-0 z-40 px-4 py-2.5 flex items-center justify-between border-b border-slate-200/90 transition-all select-none">
