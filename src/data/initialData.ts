...
export const INITIAL_USERS: UserAccount[] = [
  ...
  {
    id: 'user-admin',
    name: 'Carlos Silva (Gerente de Redes / NOC)',
    username: 'admin',
    password: '123',
    role: 'admin',
    operatorNumber: '01',
    ...
    phone: '(11) 98765-1001',
    department: 'NOC / Infraestrutura de Redes',
    position: 'Coordenador NOC & Backbone',
    registrationCode: 'COL-0105',
    admissionDate: '2023-06-15',
    workSchedule: 'Segunda a Sexta: 08:00 às 17:00 (Intervalo 1h)',
    hierarchyLevel: 'gestao',
    cpf: '222.333.444-55',
    rg: '23.456.789-0',
    email: 'carlos.noc@provedor.net',
    address: 'Rua da Fibra Óptica, 120 - Jd. Conectividade',
    cnh: 'B - 98765432100',
    pixKey: '222.333.444-55',
    bankInfo: 'Itaú Unibanco - Ag 4321 C/C 54321-0',
    emergencyContact: 'Renata (Irmã) - (11) 97777-6666',
    bloodType: 'A+',
    permissions: {
      canAccessPdv: true,
      canAccessEstoque: true,
  ...
  {
    id: 'user-caixa1',
    name: 'Cláudia Souza (Suporte Técnico N1)',
    ...
    position: 'Analista de Suporte ao Cliente N1',
    registrationCode: 'COL-0428',
    admissionDate: '2024-03-01',
    workSchedule: 'Segunda a Sexta: 08:00 às 17:00 (12:00 às 13:00 Almoço)',
    hierarchyLevel: 'operacional',
    cpf: '333.444.555-66',
    rg: '34.567.890-1',
    email: 'claudia.suporte@provedor.net',
    address: 'Rua das Flores, 88 - Bairro Central',
    cnh: 'B - 55443322110',
    pixKey: 'claudia.souza@email.com',
    bankInfo: 'Nubank - Ag 0001 Conta 12345678-9',
    emergencyContact: 'Marcos (Mãe) - (11) 96666-5555',
    bloodType: 'B+',
    permissions: {
      canAccessPdv: true,
  ...
  {
    id: 'user-caixa2',
    name: 'Marcos Oliveira (Técnico de Fibra / Campo)',
    username: 'marcos',
    password: '123',
    role: 'operador',
    operatorNumber: '03',
    ...
    phone: '(11) 98765-3003',
    department: 'Operações de Campo / Fibra Óptica',
    position: 'Técnico de Instalação e Fusão de Fibra',
    registrationCode: 'COL-0512',
    admissionDate: '2024-05-20',
    workSchedule: 'Segunda a Sábado: 08:30 às 17:30 (Intervalo 1h)',
    hierarchyLevel: 'supervisao',
    cpf: '444.555.666-77',
    rg: '45.678.901-2',
    email: 'marcos.campo@provedor.net',
    address: 'Av. Brasil, 450 - Parque das Torres',
    cnh: 'AB - 99887766554',
    pixKey: '444.555.666-77',
    bankInfo: 'Bradesco - Ag 2345 C/C 87654-3',
    emergencyContact: 'Patrícia (Esposa) - (11) 95555-4444',
    bloodType: 'O-',
    permissions: {
      canAccessPdv: true,
      canAccessEstoque: false,
